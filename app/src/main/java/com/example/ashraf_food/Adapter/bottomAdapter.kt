...
class BottomAdapter(val context: Context, private val bottomCategory: ArrayList<Bottom>) : RecyclerView.Adapter<BottomAdapter.BottomInnerClas>() {
    ...
    override fun onBindViewHolder(holder: BottomInnerClas, position: Int) {
        ...
        Picasso.get().load(currentBottomItem.strCategoryThumb)
            .into(holder.image1)
